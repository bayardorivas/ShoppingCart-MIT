...
const Products = (props) => {
  ...
  // const photos = ["apple.png", "orange.png", "beans.png", "cabbage.png"]; Bar
...
// // Iterar products, si existe en la Api actualizo instock la cantidad , si no
// // existe se agrega con todo a products

//   const restockProducts = (url) => {
//     doFetch(url);
//     let notInProductsArray = [];
...
//         } else {
//           notInProductsArray.push({ name, country, cost, instock });
//         }
//       }
//       return { name, country, cost, instock };
//     });

//     setItems([...items, ...newItems, ...notInProductsArray]);
//   };
  ...
  const restockProducts = (url) => {
    ...
    let restockItems = data.data.map((item) => {
      let { name, country, cost, instock} = item.attributes;
      let flag = true;
      // Increment stock of existent items verified by name
      items.forEach((item) => {
        if (item.name === name){
          flag = false;
